...
function Experience() {
  ...
  return (
    <div className="experience flex flex-col items-center justify-start px-[5rem] bg-[#F2F2F2] h-[50rem] pt-[14rem] mt-[-10rem] relative z-[2] rounded-b-[5rem]">
      {/* titld icon */}
      ...
      {/* features  */}
      <div className="feature1 relative w-[30%] h-[20%]">
        <h1>NEW RELEASE</h1>
        <br />
      <img src={dings}></img>
      </div>
      <div className="feature2 relative w-[70%] h-[20%]">
        <br />
      <h1>SYQEM</h1>
      <br />
      ...
      <div className="feature3 relative w-[70%] h-[20%]">
